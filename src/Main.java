...
public class Main  {
    ...
    public static void main (String[] args) {
        ...
        while (running) {
            ...
            System.out.println("BBBBBBBB B    Y       Y     TTTTTTTTTT     EEEEEEEEE               M       M     EEEEEEEEE ");
            System.out.println("B          B   Y     Y          T          E                      M M     M  M   E         ");
            System.out.println("B          B    Y   Y           T          E            -----    M   M   M   M   E         ");
            System.out.println("BBBBBBBB B        Y             T          EEEEEEEEE    -----   M    M  M    M   EEEEEEEE  ");
            System.out.println("B          B      Y             T          E            -----   M     M      M   E         ");
            System.out.println("B          B      Y             T          E                    M            M   E         ");
            System.out.println("BBBBBBBB B        Y             T          EEEEEEEEE            M            M   EEEEEEEEE ");
            System.out.println(" ");
